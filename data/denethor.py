...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, tifroot, labelgeojson, transform=None, min_area = 1000, sequencelength=365):
    ...
    def __getitem__(self, item):
        ...
        y = torch.tensor(CROP_IDS.index(feature.crop_id))

        return torch.from_numpy(image_stack).double(), y.repeat(self.sequencelength)

if __name__ == '__main__':
    tifroot = "/ssd2/ai4food_brandenburg/ai4food_brandenburg/33N/17E-243N/PF-SR"
    labelgeojson = "/ssd2/ai4food_brandenburg/brandenburg_crops_test_2019.geojson"
    ds = Dataset(tifroot, labelgeojson)
