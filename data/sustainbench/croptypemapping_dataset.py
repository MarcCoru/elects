...
class CropTypeMappingDataset(Dataset):
    """
    ...
    def __init__(self, version=None, root_dir='data', download=False, split_scheme='official', 
        ...
        self._data_dir = self.data_dir = root_dir # self.initialize_data_dir(root_dir, download)
        ...
        self._y_size = self.y_size = (IMG_DIM, IMG_DIM)
